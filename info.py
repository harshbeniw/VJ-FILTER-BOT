...
# Bot information
SESSION = environ.get('SESSION', '@Complex_Movie_bot')
...
OWNER_USERNAME = environ.get('OWNER_USERNAME', 'king lucifer') # owner username without @
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/INFINITE_MOVIES_2024')
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', '@Bot_father_lover') # Support Chat Link Without https:// or @
